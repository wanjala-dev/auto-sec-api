...
if Isaac's engagement dictates pace.

⚠️ **One re-weighting the competitive research forces (§5): P3 is not the tidy-up phase — it is the
differentiated one.** "We show you what your agents did" is already commoditized and "we inventory
your agents" will be within twelve months; the only claim nobody has shipped is **evidence verifiable
outside the operator**. So P3 both **licenses the word "provable"** (until it lands the copy says
"logged and attributable") **and is the moat**. If sequencing pressure forces a cut, cut P4 before P3.
...
| R31 | ⚠️ **EU AI Act Articles 12 / 19 / 26(6) deferred to 2027-12-02** by Regulation (EU) 2026/1744 (in force 2026-07-27); only **Article 50 transparency** went live 2026-08-02 (penalties €15M / 3%) | https://eur-lex.europa.eu/eli/reg/2026/1744/oj · https://digital-strategy.ec.europa.eu/en/news/commission-starts-enforcing-ai-act-rules-and-new-transparency-requirements-2-august · https://www.cyberlawwatch.com/2026/07/31/eu-digital-omnibus-on-ai-enters-into-force/ |
| R32 | ⚠️ **OWASP Top 10 for LLM Apps 2026 edition (August 2026)** — **Excessive Agency is `LLM03:2026`**; ranking is 75% practitioner vote + 25% incident data over 7,714 incidents; ⚠️ **monitoring is listed under "will not prevent … but can limit the level of damage caused"** | https://genai.owasp.org/download/56857 · https://www.helpnetsecurity.com/2026/08/06/owasp-2026-llm-top-10-released/ |
| R33 | ⭐ **OWASP Agentic Security Initiative threat `T8` "Repudiation & Untraceability"**; ASI10 mit. 1 ("immutable and signed audit logs of all agent actions, tool calls, and inter-agent communication"); ASI08 mit. 10 ("tamper-evident, time-stamped logs bound to cryptographic agent identities"); ASI03 "attribution gap"; ⚠️ **ASI03 mit. 6 points buyers at Entra / Bedrock / Agentforce** | OWASP Top 10 for Agentic Applications 2026 (published 2025-12-09) · https://genai.owasp.org/resource/aiuc-1-crosswalks-owasp-top-10-for-agentic-applications/ |
| R34 | **CSA MAESTRO Layer 7** independently names the same threat — agents "denying actions they performed… due to the difficulty in tracing actions back to an AI agent"; and a compromised orchestrator controls its own audit trail, requiring **external out-of-band monitoring** | CSA MAESTRO (2025-02-06) |
| R35 | ⚠️ **MITRE ATLAS content `v2026.07` (2026-08-07)** — 16 tactics / 101 techniques / 77 sub-techniques; **no separate agentic matrix** (format v6.0.0 added a `platform` field with `Agentic AI`); **agent tool credential harvesting = `AML.T0098`, added v5.2.0 (2026-01-30)**; `T0110.002` Runtime Response added 2026-08-07 | https://github.com/mitre-atlas/atlas-data/releases/tag/v2026.07 · https://api.github.com/repos/mitre-atlas/atlas-data/releases/tags/v5.2.0 · https://raw.githubusercontent.com/mitre-atlas/atlas-data/main/CHANGELOG.md |
| R36 | ATLAS agentic techniques originated in a **Zenity Labs** contribution (14 in v5.0.0, 2025-10-15; five more in the first 2026 update) | https://zenity.io/blog/current-events/zenity-labs-and-mitre-atlas-collaborate-to-advances-ai-agent-security-with-the-first-release-of |
| R37 | ⭐ **ISO/IEC 42001 control A.6.2.8 "AI system recording of event logs"**; ⚠️ text via ISMS.online (iso.org 403) — verify against the purchased standard | https://www.isms.online/iso-42001/annex-a-controls/a-6-ai-system-life-cycle/a-6-2-8-ai-system-recording-of-event-logs/ |
| R38 | ⭐ **Shared Assessments SIG Workbook added ISO/IEC 42001 + AI-lifecycle content in its 2025-09-19 release, carried into the 2026 SIG** — the defensible evidence that AI governance reaches vendors through procurement | https://sharedassessments.org/blog/2026-sig-workbook-updates/ · https://mitratech.com/resource-hub/blog/sig-2026-key-updates-and-considerations/ |
| R39 | ⭐ **PCI SSC "AI Principles: Securing the Use of AI in Payment Environments" (2025-09-11)** — AI must be "deployed so that the actions performed by the AI can be logged and monitored, and a (human) individual held responsible"; logging "sufficient to audit the prompt inputs and reasoning process"; treat AI as a potential "malicious insider" | https://blog.pcisecuritystandards.org/ai-principles-securing-the-use-of-ai-in-payment-environments |
| R40 | ⚠️ **SAQ A scope:** Stripe full-redirect / iframe merchants fall under SAQ A where **Requirement 10 is essentially not applicable**; 6.4.3 and 11.6.1 were relocated into SAQ A **eligibility criteria** (March 2025), applying to iframe but not full redirect | https://blog.pcisecuritystandards.org/important-updates-announced-for-merchants-validating-to-self-assessment-questionnaire-a · https://www.compassitc.com/blog/saq-a-requirements-6.4.3-11.6.1-what-the-eligibility-change-means |
| R41 | ⚠️⚠️ **Microsoft Agent 365 GA 2026-05-01 at $15/user/month; Purview Audit covers "all agent-to-human, human-to-agent, agent-to-tools, and agent-to-agent interactions," auto-enabled per agent instance**; from 2026-07-01 third-party cloud-agent discovery requires an Agent 365 licence | https://learn.microsoft.com/en-us/purview/ai-agent-365 |
| R42 | ⭐ **`draft-schrock-ep-authorization-receipts-10` (2026-08-06) "Authorization Receipts for High-Risk Agent Actions"** — names the action gap, the accountability gap ("approvals are mutable database records") and the **verification gap** ("evidence must be auditable outside the operator"); Trust Receipts carry a **Merkle inclusion proof against a signed log checkpoint**, verifiable fully offline. ⚠️ individual submission, not WG-adopted | https://datatracker.ietf.org/doc/draft-schrock-ep-authorization-receipts/ |
| R43 | ⭐ **Langfuse (in our stack) acquired by ClickHouse, announced 2026-01-16**; its own docs disclaim runtime security — Langfuse is for "the **ex-post evaluation** of the effectiveness of these measures"; audit logs are Enterprise-only and admin-action-only | ClickHouse/Langfuse announcement (2026-01-16) · Langfuse security docs |
| R44 | **Zenity $125M Series C (2026-08-03)**, Gartner "the company to beat in AI agent governance" (April 2026); **Obsidian $85M Series D at $1.1B (2026-08-04)** with browser-extension capture "confirming what actually happened, not just what server APIs reported"; ⭐ **Palo Alto completed the Portkey (AI Gateway) acquisition 2026-05-29** to make it "the foundational AI gateway inside Prisma AIRS" | https://www.paloaltonetworks.com/company/press/2026/palo-alto-networks-completes-acquisition-of-portkey-to-secure-ai-agents |
| R45 | ⚠️ **AWS AgentCore: "By default, AgentCore outputs a set of span data for memory resources only. To record span data for your agents or gateway resources, you need to instrument your agent"** — CloudTrail sees `InvokeAgentRuntime`, not the tool calls inside. **Anthropic's hosted Compliance API "does not log inference activities."** **OpenAI announced shutdown of Agent Builder + Evals (2026-11-30)** | AWS AgentCore docs · https://platform.claude.com/docs/en/manage-claude/compliance-api |
| R46 | **NIST:** AI RMF **GOVERN 1.6** (inventory AI systems) + **MEASURE 2.8** (maintain histories, audit logs); **CAISI AI Agent Standards Initiative (2026-02-17)**; **NCCoE agent identity/authorization initial public draft (2026-02-05)** seeking input on "auditing and non-repudiation of AI agents". ⚠️ **AI 600-1 does NOT contain the widely-quoted "log tool calls" language** | https://www.nist.gov/news-events/news/2026/02/announcing-ai-agent-standards-initiative-interoperable-and-secure · https://csrc.nist.gov/pubs/other/2026/02/05/accelerating-the-adoption-of-software-and-ai-agent/ipd |
