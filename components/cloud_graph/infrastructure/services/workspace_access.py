"""Workspace membership gate for the cloud-graph read API.

A small, boundary-clean copy (as in ``findings`` / ``cloud_posture``): it reads the
shared ``WorkspaceMembership`` persistence model — the outermost ring — rather than
