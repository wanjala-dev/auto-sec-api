...
class TestGraderVerifierTool:
    ...
    # NOTE: the grounded-verdict-from-a-real-finding case lives in
    # tests/integration/test_rubric_grader_verifier_grounded.py — it needs a
    # real Task row (django_db), which disqualifies it from the unit tier.
