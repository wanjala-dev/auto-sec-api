...
def test_invitation_email_includes_password_setup_link_for_new_user():
    ...
    # The canonical SPA route — the legacy /PasswordResetConfirm/ path has no
    # frontend route and dead-ended invited users at the login screen.
    assert "/identity/password-reset-confirm/" in html_body
