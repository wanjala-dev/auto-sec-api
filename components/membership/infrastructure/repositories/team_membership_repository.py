"""ORM team membership repository.

Extracted from ``components.team.infrastructure.repositories.team_membership_repository``.
"""
...
class OrmTeamMembershipRepository(TeamMembershipPort):
    ...
    def enroll_user_in_team(
        ...
        *,
        ...
        # Only mark as contributor if they are not already staff/superuser
        # to avoid downgrading admin users who donate or sponsor.
        if (
            self.contributor_enrollment_policy.should_mark_contributor(
